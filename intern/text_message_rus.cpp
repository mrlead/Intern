...
void text::main_hospital()
{
	...
	cout << GetIniString("5", "hospital", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("6", "hospital", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("7", "hospital", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("8", "hospital", "ini_base/menu_list_rus.ini") << endl;
}

void text::main_head_d()
{
	setlocale(LC_ALL, "RUSSIAN");
	cout << GetIniString("1", "head_doctor", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("2", "head_doctor", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("3", "head_doctor", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("4", "head_doctor", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("5", "head_doctor", "ini_base/menu_list_rus.ini") << endl;
}

void text::main_doct()
{
	setlocale(LC_ALL, "RUSSIAN");
	cout << GetIniString("1", "doctor", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("2", "doctor", "ini_base/menu_list_rus.ini") << endl;
...
{
	setlocale(LC_ALL, "RUSSIAN");
	cout << GetIniString("1", "about_pr_rus", "ini_base/about.ini") << endl;
	cout << GetIniString("2", "about_pr_rus", "ini_base/about.ini") << endl;
	cout << GetIniString("3", "about_pr_rus", "ini_base/about.ini") << endl;
	cout << GetIniString("4", "about_pr_rus", "ini_base/about.ini") << endl;
	cout << GetIniString("5", "about_pr_rus", "ini_base/about.ini") << endl;
	cout << GetIniString("6", "about_pr_rus", "ini_base/about.ini") << endl;
}

void text::author_rus()
{
	setlocale(LC_ALL, "RUSSIAN");
	cout << GetIniString("1", "author_rus", "ini_base/about_author.ini") << endl;
	cout << GetIniString("2", "author_rus", "ini_base/about_author.ini") << endl;
	cout << GetIniString("3", "author_rus", "ini_base/about_author.ini") << endl;
	cout << GetIniString("4", "author_rus", "ini_base/about_author.ini") << endl;
	cout << GetIniString("5", "author_rus", "ini_base/about_author.ini") << endl;
	cout << GetIniString("6", "author_rus", "ini_base/about_author.ini") << endl;
	cout << GetIniString("7", "author_rus", "ini_base/about_author.ini") << endl;
}

void text::main_set()
{
	setlocale(LC_ALL, "RUSSIAN");
	cout << GetIniString("1", "help", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("2", "help", "ini_base/menu_list_rus.ini") << endl;
	cout << GetIniString("3", "help", "ini_base/menu_list_rus.ini") << endl;
}

void text::inst_rus()
{
	setlocale(LC_ALL, "RUSSIAN");
	cout << GetIniString("1", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("2", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("3", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("4", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("5", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("6", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("7", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("8", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("9", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("10", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("11", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("12", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("13", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("14", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("15", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("16", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("17", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("18", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("19", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("20", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("21", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("22", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("23", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("24", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("25", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("26", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("27", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("28", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("29", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("30", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("31", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("32", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("33", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("34", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("35", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("36", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("37", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("38", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("39", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("40", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("41", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("42", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("43", "inst_rus", "ini_base/instr.ini") << endl;
	cout << GetIniString("44", "inst_rus", "ini_base/instr.ini") << endl;
